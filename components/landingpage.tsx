...
export default function LandingPage() {
    return (
        <main className="flex items-center p-10 mt-10 gap-40 animate-fade-in max-md:flex-col">
        {/* Section with branding, heading, subheading, and illustration */}
        <section className="flex flex-col gap-3 items-center pl-20">
            {/* App Logo */}
            <img
