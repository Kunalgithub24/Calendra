...
export default function PublicNavBar() {
    return (
        <nav className="flex justify-between items-center fixed z-50 w-full h-28 bg-gray-300 px-10 gap-4 ">
            {/* Logo */}
            <Link href="/login" className="flex items-center gap-1 hover:scale-150 duration-500 ">
            <Image
                src="/assets/calender logo.png"
                width={60}
                height={60}
                alt="calendra logo"
            />
            ...
            <section className="sticky top-0 flex justify-between  ">
                ...
                <SignInButton>
                    <Button
                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 cursor-pointer hover:scale-150 duration-500 rounded-2xl"
                    >
                        Login
                    </Button>
                </SignInButton>
