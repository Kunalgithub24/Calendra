...
export default function NewEventPage(){
    return (
        ...
        //**ALL THIS BUTTON KNOWELEDGE IS FROM SHCDCN COMPONENT CARD, CARD HEADER, CARD TITLE, CARD DESCRIPTION, CARD CONTENT, CARD FOOTER EVERYTHING.

        <Card className="max-w-md mx-auto border-8 border-blue-200 shadow-lg">
